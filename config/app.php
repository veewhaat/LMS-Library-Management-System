...
return [
     ...
     *
     * Configure the authorization service for your application
     */
    'Authorization' => [
        // Authorization configuration can be added here if needed
    ],
    ...
    'Session' => [
        'defaults' => 'php',
        'timeout' => 120, // 2 hours - good for "remember me" functionality
        'cookieParams' => [
            'lifetime' => 604800, // 1 week for "remember me"
        ],
    ],
     ...
     *  - `forceEnable` - Force DebugKit to display. Careful with this, it is especially useful when working with authentication
